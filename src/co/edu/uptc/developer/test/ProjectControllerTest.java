...
public class ProjectControllerTest {
    ...
    void testCreateProjectSuccess() throws ParseException {
        ResultDTO result = projectController.createProject(
                "1001", "Proyecto A", "31/05/2026", "5000",
    ...
    void testCreateProjectDuplicate() throws ParseException {
        projectController.createProject(
                "1002", "Proyecto B", "31/05/2026", "6000",
    ...
    void testFindProjectByIdAndName() throws ParseException {
        projectController.createProject("1003", "Proyecto C", "31/05/2026", "7000",
                StatusEnum.PLANNING, "Proyecto de búsqueda");
    ...
    void testUpdateProject() throws ParseException {
        projectController.createProject(
                "1004", "Proyecto D", "31/05/2026", "8000",
                StatusEnum.PLANNING, "Proyecto inicial");

        ResultDTO result = projectController.updateProject(
                "1004", "Proyecto D", "31/05/2026", "9000",
    ...
    void testDeleteProject() throws ParseException {
        projectController.createProject(
                "1005", "Proyecto E", "31/05/2026", "10000",
                StatusEnum.PLANNING, "Proyecto a eliminar");
    ...
    void testCreateProjectInvalidDate() throws ParseException {
        ResultDTO result = projectController.createProject(
                "1006", "Proyecto F", "2026-05-31", "5000",
