...
public class DeveloperControllerTest {
    ...
    void testCreateDeveloperSuccess() {
        ...
        ResultDTO result = developerController.createDeveloper(
                "1233", "Sofía", "Gonzalez", "Java", "5", "3000.0", "sofiagonzalez@mail.com",
                project, computer);
    ...
    void testFindDeveloperById() {
        ...
        developerController.createDeveloper(
                "2000", "Angelica", "Beltran", "Java", "5", "3000.0", "angelica@mail.com",
                project, computer);
    ...
    void testUpdateDeveloper() {
        ...
        developerController.createDeveloper(
                "3000", "Ana", "Lopez", "Java", "5", "2800.0", "ana@mail.com",
                project, computer);

    
        ResultDTO result = developerController.updateDeveloper(
                "3000", "Ana", "Lopez", "Java", "5", "3500.0", "ana@mail.com",
                project, computer);
    ...
    void testDeleteDeveloper() {
        ...
        developerController.createDeveloper(
                "4000", "Laura", "Martinez", "Java", "2", "2000.0", "laura@mail.com",
                project, computer);
